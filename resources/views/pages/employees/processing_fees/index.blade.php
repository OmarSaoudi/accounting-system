...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Processing Fee Employees</li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Processing Fee Employees List <small>{{ $processing_fees->count() }}</small></h3>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                <td>{{ $loop->index + 1 }}</td>
                <td>{{ $processing_fee->employee->name }}</td>
              ...
              @include('pages.employees.processing_fees.delete')
              @endforeach
              </tbody>
              <tfoot>
              <tr>
