...
<div class="content-wrapper">
   ...
   <section class="content-header">
     ...
     <ol class="breadcrumb">
       ...
       <li class="active">Create Payment Employee</li>
     </ol>
   </section>
   ...
   <section class="content">
      <div class="box box-primary">
          <div class="box-header">
              <h3 class="box-title">Create Payment Employee</h3>
          </div>
            <div class="box-body">
                    <form method="POST" action="{{ route('payment_employees.store') }}" autocomplete="off">
                      @csrf
                        {{-- 1 --}}
                        <div class="row">
                           <div class="col-md-6">
